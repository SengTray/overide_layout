    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{route('product_add')}}" class="btn btn-added"><img src="{{asset('assets/img/icons/plus.svg')}}"
                        ...
                        <table class="table  datanew">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Admin</td>
                                    <td>
                                        <a class="me-3" href="{{route('product_detail')}}">
                                            <img src="{{asset('assets/img/icons/eye.svg')}}" alt="img">
                                        </a>
                                        <a class="me-3" href="{{url('product/product_edit/1')}}">
